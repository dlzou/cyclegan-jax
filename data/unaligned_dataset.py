...
class UnalignedDataset_train(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        return {"A": A_train, "B": B_train, "A_paths": A_path_train, "B_paths": B_path_train}

    def __len__(self):
        return max(self.A_size_train, self.B_size_train)



class UnalignedDataset_val(BaseDataset):
    def __init__(self, opt):
